      ...
      <div className="container">
          <Scroll.SpyLink activeClass="customActive">
            <div className="sidebar">
                ...
                {/* <div className="current-section">Section: {this.state.section}</div> */}
            </div>
          </Scroll.SpyLink>
          <Scroll.Spy>
            <div className="main">
                ...
                <div>
                    ...
                    <p>Beethoven's love life was hampered by className issues. In late 1801 he met a young countess, Julie ("Giulietta") Guicciardi through the Brunsvik family, at a time when he was giving regular piano lessons to Josephine Brunsvik. Beethoven mentions his love for Julie in a November 1801 letter to his boyhood friend, Franz Wegeler, but he could not consider marrying her, due to the className difference. Beethoven later dedicated to her his Sonata No. 14, now commonly known as the Moonlight sonata or Mondscheinsonate (in German).[69]
                        Für Elise
                        MENU0:00
